...
# Agregamos la moda como una fila adicional
...
tabla_prov_inicial <- kbl(stats_prov_inicial, align = "c", col.names = c("Estadístico", "Valor")) %>%
  kable_material()
...
grid.arrange(plot_hist_dens_prov_inicial,
             plot_boxplot_prov_inicial,
             plot_geomplot_prov_inicial,
             plot_qqplot_prov_inicial,
             ncol=2)
```
...
tabla_prov_cob <- kbl(stats_prov_cob, align = "c", col.names = c("Estadístico", "Valor")) %>%
  kable_material()
...
tabla_pago_total_cob <- kbl(stats_pago_total_cob, align = "c", col.names = c("Estadístico", "Valor")) %>%
  kable_material()
...
tabla_coste_total_cob <- kbl(stats_coste_total_cob, align = "c", col.names = c("Estadístico", "Valor")) %>%
  kable_material()
